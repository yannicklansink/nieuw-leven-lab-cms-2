// Dit bestand definieert de hoofdpagina (index) van de blogsectie.
// Het haalt alle gesorteerde blogposts op en geeft ze weer met behulp van BlogListItem.
...
async function BlogPage() {
  ...
  return (
    ...
    <div className="container mx-auto px-4 py-12 md:py-16">
      <h1 className="text-center text-4xl mb-12">Onze gezondheidscontent</h1>
