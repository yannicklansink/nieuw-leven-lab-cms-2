...
const Button: React.FC<ButtonProps> = ({
  ...
  asSpan, // Destructure the new prop
  ...props
}) => {
  const baseClasses =
    "group rounded-full py-2 px-6 inline-flex items-center space-x-2 transition-all font-medium w-fit text-sm";
  ...
  // Conditionally render a span if asSpan is true
  if (asSpan) {
    return (
