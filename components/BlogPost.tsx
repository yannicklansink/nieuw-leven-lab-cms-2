...
import Image from 'next/image'; // Importeer Image
...
const BlogPost: React.FC<BlogPostProps> = ({ title, date, contentHtml, coverImage }) => {
  return (
    ...
    <article className="prose lg:prose-lg xl:prose-xl max-w-none mx-auto py-8 md:py-12">
      ...
      {/* Datum */}
      <p className="text-gray-600 text-base !mt-0 !mb-8">Gepubliceerd op: {date}</p> 
      {/* HTML Content */}
