...
import Button from "@/components/elements/Button"; // Button component importeren
...
type CardType = {
  ...
  title: string;
  category: string;
  content?: React.ReactNode; // Content optioneel gemaakt met '?'
};
      ...
      >
        ...
        <div className="relative z-20 p-6 md:p-8 w-full">
          <motion.p
            ...
            className="text-left text-[rgb(var(--color-light-green))] md:text-base"
          >
            {card.category}
          </motion.p>
          <motion.p
